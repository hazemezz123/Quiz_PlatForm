    ...
    comparisons: [
      {
        ...
        rows: [
          { feature: 'Definition', values: ['Associated with the OS but not necessarily part of the kernel', 'Defines how system resources are used to solve users\' computing problems'] },
          { feature: 'Purpose', values: ['Supports system operation and management', 'Performs tasks for end users'] },
          { feature: 'Examples', values: ['Shell, Antivirus, Firewall, Disk Utilities', 'MS Word, Web Browsers, Video Games'] },
        ],
      },
      {
        ...
        rows: [
          { feature: 'Bootstrap', values: ['Small program that runs when the computer powers up, initializes hardware, and loads the kernel into memory'] },
          { feature: 'Kernel', values: ['The core program always running; manages CPU, memory, and hardware resources'] },
          { feature: 'Shell', values: ['User interface that interprets commands and communicates with the kernel'] },
        ],
      },
      {
        ...
        rows: [
          ...
          { feature: 'Response Time', values: ['Delayed response', 'Fast response (Time-Sharing)'] },
          { feature: 'Suitable Tasks', values: ['Payroll, Billing, Repetitive Jobs', 'Debugging, General Computing'] },
        ],
      },
      {
        ...
        rows: [
          { feature: 'Deadline Requirement', values: ['Strict deadlines must always be met', 'Some deadline variation is acceptable'] },
          { feature: 'Response Variation (Jitter)', values: ['Not allowed', 'Limited jitter allowed'] },
          { feature: 'Example Usage', values: ['Airbags, Medical Devices', 'Multimedia, Online Streaming'] },
        ],
      },
      {
        ...
        rows: [
          ...
          { feature: 'CPU', values: ['Processing unit inside the processor that executes instructions'] },
          { feature: 'Core', values: ['Smallest execution unit capable of independently running instructions'] },
        ],
      },
      {
        ...
        rows: [
          { feature: 'Control', values: ['All CPUs are equal and cooperate', 'Master CPU controls subordinate CPUs'] },
          { feature: 'OS Copy', values: ['All CPUs run the same OS copy', 'Master manages task assignment'] },
          { feature: 'Decision Making', values: ['Independent decisions', 'Centralized decisions'] },
        ],
      },
      {
        ...
        rows: [
          { feature: 'CPU Switching', values: ['Occurs when a process waits for I/O', 'Occurs when time quantum expires'] },
      ...
      },
      {
        ...
        rows: [
          ...
          { feature: 'Qubit', values: ['Quantum bit that can be 0, 1, or both simultaneously (Superposition)'] },
        ],
      },
      {
        ...
        rows: [
          ...
          { feature: 'Speed', values: ['Fastest memory', 'Faster than RAM but slower than registers'] },
          { feature: 'Function', values: ['Holds currently processed data', 'Stores frequently used data'] },
      ...
      },
      {
        ...
        rows: [
          { feature: 'Purpose', values: ['Controls access to resources', 'Defends against threats and attackers'] },
          { feature: 'Focus', values: ['Internal users/processes', 'External threats and unauthorized access'] },
        ],
      },
      {
        ...
        rows: [
          { feature: 'Definition', values: ['Passive executable file on disk', 'Active program in execution'] },
          { feature: 'State', values: ['Static', 'Dynamic'] },
          { feature: 'Resource Usage', values: ['Does not use resources directly', 'Uses CPU, memory, and other resources'] },
        ],
      },
      {
        ...
        rows: [
          { feature: 'Context Switching', values: ['Frequent (High Overhead)', 'Less frequent (Low Overhead)'] },
          { feature: 'Responsiveness', values: ['Better', 'Worse'] },
          { feature: 'Extreme Case', values: ['Very responsive', 'Behaves like FCFS if too large'] },
        ],
      },
      {
        ...
        rows: [
          ...
          { feature: 'wait()', values: ['Parent waits for child process termination and collects status'] },
        ],
      },
      {
        ...
        rows: [
          ...
          { feature: 'Cause', values: ['Parent hasn\'t called wait()', 'Parent exits before child'] },
        ],
      },
      {
        ...
        rows: [
          { feature: 'Method', values: ['Eliminates at least one deadlock condition', 'Dynamically checks for safe states'] },
      ...
      },
      {
        ...
        rows: [
          { feature: 'Definition', values: ['Independent program in execution', 'Lightweight execution unit within a process'] },
      ...
      },
      {
        ...
        rows: [
          ...
          { feature: 'Blocking Behavior', values: ['One blocked thread blocks entire process', 'Other threads can continue running'] },
        ],
      },
      {
        ...
        rows: [
          ...
          { feature: 'Synchronization', values: ['Manual synchronization required', 'Built-in synchronization'] },
